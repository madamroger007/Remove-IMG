<script lang="ts">
	...
	const title = 'Remove Background - Musseum Image Generator';
	const description =
		'A website that helps you remove background images easily and quickly.';
